...
public class CameraStacleAspect2 : MonoBehaviour
{
    [SerializeField]
    Camera refCamera;
    ...
    void UpdateCamera()
    {
        ...
        if (aspect < targetAcpect)
        {
            ...
            refCamera.rect = new Rect( 0.375f, (1f-camHeight)*0.5f+(camHeight*0.1f), 0.25f, camHeight*0.2f);
        }
        // 横に長い
        else
        {
            ...
            refCamera.rect = new Rect( (1f-camWidth)*0.5f+(camWidth*0.375f), 0.1f, camWidth*0.25f, 0.2f);
        }
