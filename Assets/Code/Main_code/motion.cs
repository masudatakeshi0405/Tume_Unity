...
public class motion : MonoBehaviour
{
    ...
    {
        //
        switch(Ball.GetComponent<BallControl_BMC>().s_course)
        {
            case 1:
                if (Ball.GetComponent<BallControl_BMC>().turncou==1)
                {
                    //Bool型のパラメーターであるblRotをTrueにする
                    anim.SetBool("forehand", true);
                }else if (Ball.GetComponent<BallControl_BMC>().boundcount==2){
                    //Bool型のパラメーターであるblRotをTrueにする
            ...
            case 4:
                if (Ball.GetComponent<BallControl_BMC>().boundcount==2)
                {
                    //Bool型のパラメーターであるblRotをTrueにする
        ...
        //     x = Ball.transform.position.x + 10;
        // }else if(Ball.transform.position.x > 5){
        //     x = Ball.transform.position.x - 5;
        // }
