...
public class Issue_Comment_S01 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        img10 = GameObject.Find("Image_issue10");
        img11 = GameObject.Find("Image_issue11");
    ...
    void Update()
    {
        switch(Ball.GetComponent<BallControl_BMC_S01>().turncou)
        {
            case 0:
