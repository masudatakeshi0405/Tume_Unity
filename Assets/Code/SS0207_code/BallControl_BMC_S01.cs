...
public class BallControl_BMC_S01 : MonoBehaviour
{
            ...
            //----------------------------ナックルサービス----------------------------
                ...
                switch(s_course)
                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        rb.AddForce(-3 * thrust, -11 * thrust, 23 * thrust); //前フォア
                        break;
                    case 5:
                        rb.AddForce(2 * thrust, -11 * thrust, 23 * thrust); //前ミドル
                        break;
                    case 6:
                        rb.AddForce(7 * thrust, -11 * thrust, 23 * thrust); //前バック
                        break;
            ...
            //--------------------------ドライブ--------------------------------
                ...
                switch(r_course)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        rb.AddForce((transform.position.x) * -20, 2 * thrust, -25 * thrust); //ミドル
                        break;
                    case 6:
                        rb.AddForce((transform.position.x+10) * -20, 2 * thrust, -25 * thrust); //バック
                        break;
                }
                break;
                    ...
                    case 2:
                        switch(r_course)
                        {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                rb.AddForce((transform.position.x-22) * -15, 11 * thrust, -17 * thrust); //前フォア
                                break;
                            case 5:
                                rb.AddForce((transform.position.x) * -15, 8 * thrust, -22 * thrust); //前ミドル
                                break;
                            case 6:
                                rb.AddForce((transform.position.x+22) * -15, 11 * thrust, -17 * thrust); //前バック
                                break;
                        }
                        break;
