                    ...
                    switch(r_course)
                    {
                        case 1:
                            if(s_course<4){
                                ...
                                rb.AddForce((transform.position.x-22) * -20, 2 * thrust, -25 * thrust); //フォア
                            }
                            break;
                        case 2:
                            if(s_course<4){
                                ...
                                rb.AddForce((transform.position.x) * -20, 2 * thrust, -25 * thrust); //フォア
                            }
                            break;
                        case 3:
                            if(s_course<4){
                        ...
                        case 4:
                            if(s_course<4){
                                rb.AddForce((transform.position.x-10) * -20, 10 * thrust, -28 * thrust); //フォア
                            }else{
                                rb.AddForce((transform.position.x-10) * -20, 2 * thrust, -25 * thrust); //フォア
                            }
                            break;
                        case 5:
                            if(s_course<4){
                                rb.AddForce((transform.position.x) * -20, 10 * thrust, -28 * thrust); //フォア
                            }else{
                                rb.AddForce((transform.position.x) * -20, 2 * thrust, -25 * thrust); //フォア
                            }
                            break;
                ...
                switch(s_style)
                {
                    ...
                    // rb.AddForce((transform.position.x+22) * -15, 10 * thrust, -18 * thrust); //前バック
                        switch(r_course)
                        {
                            ...
                            case 4:
                                if(s_course<=3){
                                    rb.AddForce((transform.position.x-22) * -15, 11 * thrust, -26 * thrust); //フォア
                                }else{
                                    rb.AddForce((transform.position.x-22) * -13, 10 * thrust, -19 * thrust); //前フォア
                                }
                                break;
                            case 5:
                                if(s_course<=3){
                                    rb.AddForce((transform.position.x) * -15, 11 * thrust, -26 * thrust); //フォア
                                }else{
                                    rb.AddForce((transform.position.x) * -13, 10 * thrust, -19 * thrust); //前フォア
                                }
                                break;
                    ...
                    switch(r_course)
                    {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            rb.AddForce((transform.position.x-22) * -15, 14 * thrust, -19 * thrust); //前フォア
                            break;
                        case 5:
                            rb.AddForce((transform.position.x) * -15, 14 * thrust, -19 * thrust); //前ミドル
                            break;
                        case 6:
                            rb.AddForce((transform.position.x+22) * -15, 14 * thrust, -19 * thrust); //前バック
                            break;
                    }
                    break;
                }
                ...
                switch(s_style)
                {
                    ...
                    // rb.AddForce((transform.position.x+44) * -13, 10 * thrust, -18 * thrust); //前バック
                        ...
                        switch(r_course)
                        {
                            ...
                            case 4:
                                if(s_course<=3){
                                    rb.AddForce((transform.position.x) * -15, 12 * thrust, -25 * thrust); //フォア
                                }else{
                                    rb.AddForce((transform.position.x) * -13, 10 * thrust, -19 * thrust); //前フォア
                                }
                                break;
                            case 5:
                                if(s_course<=3){
                                    rb.AddForce((transform.position.x+22) * -15, 12 * thrust, -25 * thrust); //フォア
                                }else{
                                    rb.AddForce((transform.position.x+22) * -13, 10 * thrust, -19 * thrust); //前フォア
                                }
                                break;
                            case 6:
                                if(s_course<=3){
                                    rb.AddForce((transform.position.x+44) * -15, 12 * thrust, -25 * thrust); //フォア
                                }else{
                    ...
                    switch(s_style)
                    {
                            ...
                            switch(r_course)
                            {
                                ...
                                case 6:
                                    if(s_course<=3){
                                        ...
                                        rb.AddForce((transform.position.x+22) * -20, 6 * thrust, -36 * thrust); //前バックは無理
                                    }
                                    break;
                            }
                            break;
                        ...
                        // rb.AddForce((transform.position.x+22) * -20, 2 * thrust, -36 * thrust); //バックは無理
                            switch(r_course)
                            {
                                ...
                                case 4:
                                    if(s_course<=3){
                                        rb.AddForce((transform.position.x-22) * -20, 11 * thrust, -35 * thrust); //フォア
                                    }else{
                                        rb.AddForce((transform.position.x-22) * -25, 6 * thrust, -38 * thrust); //前フォア
                                    }
                                ...
                                case 5:
                                    if(s_course<=3){
                                        rb.AddForce((transform.position.x) * -20, 11 * thrust, -35 * thrust); //ミドル
                                    }else{
                                        rb.AddForce(transform.position.x * -25, 6 * thrust, -38 * thrust); //前ミドル
                                    }
                                    break;
                                case 6:
                                    if(s_course<=3){
                                        rb.AddForce((transform.position.x+22) * -20, 11 * thrust, -35 * thrust); //バックは無理
                                    }else{
                                        rb.AddForce((transform.position.x+22) * -20, 6 * thrust, -36 * thrust); //前バックは無理
                                    }
                                    break;
                    ...
                    switch(s_style){
                        ...
                        //上回転→チキータ
                            switch(r_course)
                            {
                                ...
                                case 6:
                                    if(s_course<=3){
                                        rb.AddForce((transform.position.x+22) * -15, 12 * thrust, -32 * thrust); //バックは無理
                                    }else{
                                        rb.AddForce((transform.position.x+22) * -20, 8 * thrust, -34 * thrust); //前バックは無理
                                    }
                                    break;
                            ...
                            switch(r_course){
                                ...
                                case 6:
                                    if(s_course<=3){
                                        ...
                                        rb.AddForce((transform.position.x+22) * -20, 6 * thrust, -38 * thrust); //前バックは無理
                                    }
                                    break;
                            }
                            break;
