...
public class FirstShot_S01 : MonoBehaviour
{
    ...
    void Update()
    {
        myText.text = string.Format("{0} : {1}", ss_name[Ball.GetComponent<BallControl_BMC_S01>().s_style], sc_name[Ball.GetComponent<BallControl_BMC_S01>().s_course]);
    }
}
